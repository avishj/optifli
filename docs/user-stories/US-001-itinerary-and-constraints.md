...
2. The CLI accepts per-destination stay durations as fractional days or hours (for example: HAN=2d, DAD=1.5d, PQC=2.5d, SIN=0.5d; or 12h, 30h) and validates required values in <=1 second for a 10-city payload on a reference machine.
